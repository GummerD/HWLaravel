                ...
                <tbody>
                    @forelse ($orderForms as $orderForm)
                        <tr>
                            ...
                            <td><a href="{{ route('hw_6.orderForm.edit', ['orderForm' => $orderForm]) }}">Изм.
                                </a>&nbsp;<a href="javascript:;" class="delete" rel="{{ $orderForm->id}}" style="color:red;">Уд.</a></td>
                        </tr>
                    @empty
                        <tr>
